...
// ✅ Prod me critical env vars mandatory
...
// ✅ DB SSL mode — production me verify-full recommend
const DB_SSL_MODE = process.env.DB_SSL_MODE || (isProd ? "require" : "disable");
...
export const env = {
  ...
  DB_SSL_MODE, // ✅ NEW — "disable" | "require" | "verify-ca" | "verify-full"

  // JWT — NO fallback in prod
  JWT_ACCESS_SECRET:
  ...
  REDIS_TLS: process.env.REDIS_TLS === "true", // ✅ Boolean conversion
